...
class FOOD(BaseDataLoader):
    def __init__(self, data_dir, batch_size, split, crop_size=None, base_size=None, scale=False, num_workers=1,
        ...
        self.dataset = FOODStuff(**kwargs)
        super(FOOD, self).__init__(self.dataset, batch_size, shuffle, num_workers, val_split)