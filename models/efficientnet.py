...
class EfficientNet(nn.Module):
    def __init__(self, width_coe, depth_coe, num_classes, depth_divisor=8, min_depth=None, dropout_rate=0.2,
...
class EfficientNetSeg(BaseModel):
    def __init__(self, num_classes, backbone='', **kwargs):
        ...
        if backbone == 'efficientnet_b0':
            self.backbone = efficientnet_b0(dilated=True, num_classes=num_classes, **kwargs)
        elif backbone == 'efficientnet_b1':
            self.backbone = efficientnet_b1(dilated=True, num_classes=num_classes, **kwargs)
        elif backbone == 'efficientnet_b2':
            self.backbone = efficientnet_b2(dilated=True, num_classes=num_classes, **kwargs)
        elif backbone == 'efficientnet_b3':
            self.backbone = efficientnet_b3(dilated=True, num_classes=num_classes, **kwargs)
        elif backbone == 'efficientnet_b4':
            self.backbone = efficientnet_b4(dilated=True, num_classes=num_classes, **kwargs)
        elif backbone == 'efficientnet_b5':
            self.backbone = efficientnet_b5(dilated=True, num_classes=num_classes, **kwargs)
        elif backbone == 'efficientnet_b6':
            self.backbone = efficientnet_b6(dilated=True, num_classes=num_classes, **kwargs)
        elif backbone == 'efficientnet_b7':
            self.backbone = efficientnet_b7(dilated=True, num_classes=num_classes, **kwargs)
        else:
            raise RuntimeError("Unknown backnone: {}".format(backbone))

        self.head = _FCNHead(self.backbone.in_channels, num_classes, **kwargs)
        self.init_params()
