...
class ICNet(SegBaseModel):
    ...
    def __init__(self, num_classes, backbone='resnet50', pretrained=True, **kwargs):
        super(ICNet, self).__init__(num_classes, backbone, pretrained=pretrained, **kwargs)
...
class _ICHead(nn.Module):
    def __init__(self, num_classes, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.cff_12 = CascadeFeatureFusion(128, 64, 128, num_classes, norm_layer, **kwargs)  
        self.cff_24 = CascadeFeatureFusion(2048, 512, 128, num_classes, norm_layer, **kwargs)
