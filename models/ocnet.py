...
class OCNet(SegBaseModel):
    ...
    def __init__(self, num_classes, backbone='resnet50', oc_arch='asp', aux=False, pretrained=True, **kwargs):
        super(OCNet, self).__init__(num_classes, backbone=backbone, pretrained=pretrained, **kwargs)
        self.aux=aux
