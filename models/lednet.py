...
class LEDNet(BaseModel):
    ...
    def __init__(self, num_classes, backbone='', pretrained=True, **kwargs):
...
class APNModule(nn.Module):
    def __init__(self, in_channels, num_classes, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        self.level1 = _ConvBNReLU(in_channels, num_classes, 1, norm_layer=norm_layer)
        self.level2 = _ConvBNReLU(in_channels, num_classes, 1, norm_layer=norm_layer)
        self.level3 = _ConvBNReLU(in_channels, num_classes, 1, norm_layer=norm_layer)
        self.level4 = _ConvBNReLU(in_channels, num_classes, 1, norm_layer=norm_layer)
