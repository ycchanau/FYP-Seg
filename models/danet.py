...
class DANet(SegBaseModel):
    ...
    def __init__(self, num_classes, backbone='resnet50', aux=True, pretrained=True, **kwargs):
        super(DANet, self).__init__(num_classes, backbone=backbone, pretrained=pretrained, **kwargs)
