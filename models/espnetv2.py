...
class ESPNetV2(BaseModel):
    ...
    def __init__(self, num_classes, backbone='eespnet', pretrained=False, **kwargs):
        super(ESPNetV2, self).__init__()
        self.pretrained = eespnet(pretrained=pretrained, **kwargs)
...
class EESP(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, stride=1, k=4, r_lim=7, down_method='esp', norm_layer=nn.BatchNorm2d, **kwargs):
...
class DownSampler(nn.Module):
    ...
    def __init__(self, in_channels, out_channels, k=4, r_lim=9, reinf=True, inp_reinf=3, norm_layer=None, **kwargs):
...
class EESPNet(nn.Module):
    def __init__(self, num_classes=1000, scale=1, reinf=True, norm_layer=nn.BatchNorm2d, **kwargs):
