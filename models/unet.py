...
class U_Net(BaseModel):
    def __init__(self, num_classes, img_ch=3, pretrained=True, **kwargs):
...
class R2U_Net(BaseModel):
    def __init__(self, num_classes, img_ch=3, t=2, **kwargs):
...
class AttU_Net(BaseModel):
    def __init__(self, num_classes, img_ch=3, **kwargs):
