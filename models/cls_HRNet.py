...
class CLS_HRNetV2(nn.Module):
    def __init__(self,  num_classes=3, pretrained=True, **kwargs):
...
def get_cls_hrnetv2(num_classes=3):
    model = CLS_HRNetV2(num_classes=num_classes)
    return model